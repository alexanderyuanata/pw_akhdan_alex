                ...
                <div id="login-box">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" required name="reg_user" id="reg_user"
                                placeholder="username" value="<?php echo $reg_user; ?>">
                            <label for="floatingUsername">username</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="password" class="form-control" required name="reg_pass" id="reg_pass"
                                placeholder="Password" value="<?php echo $reg_pass; ?>">
