...
if (!empty($_POST) && isset($_GET['submit'])) {
  $q = "UPDATE barang SET `nama` = '" . $_POST['nama'] . "', `harga` = '" . $_POST['harga'] .
    "', `stok` = '" . "' WHERE `id` = '" . $_POST['id'] . "';";
      ...
      <div class="col">
        <div id="add-div">
          <form method="GET">
            ...
            <label>Harga:</label>
            <input type="number" class="form-control add-c" id="edit-harga" name="harga"
              value="<?php echo $prev['harga'] ?>" required />

            <label>Stok:</label>
            <input type="number" class="form-control add-c" id="edit-stok" name="stok"
              value="<?php echo $prev['stok'] ?>" required />
